## 
# Sample NGINX INSTALL SCRIPT TO RUN ON NEW CONTAINER CREATION FOR MODSEC DYNAMIC MODULE
##
...
# --------------------- STEP-2: COMPILE the Nginx Connector -----------------------
...
# CLEANUP: REMOVE THE DIRECTORIES THAT WERE CLONED IN /opt
